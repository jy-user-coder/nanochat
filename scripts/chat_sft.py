...
parser.add_argument("--matrix-lr", type=float, default=None, help="learning rate for matrix parameters (Muon, Muon+Magma, or Adam+Magma) (default: inherit from pretrain)")
parser.add_argument("--matrix-optimizer", type=str, default=None, choices=["muon", "muon_magma", "adam_magma"], help="matrix optimizer (default: inherit from pretrain, fallback=muon)")
parser.add_argument("--magma-survival-prob", type=float, default=None, help="Magma: Bernoulli survival probability (default: inherit or 0.5)")
parser.add_argument("--magma-temperature", type=float, default=None, help="Magma: sigmoid temperature (default: inherit or 2.0)")
parser.add_argument("--magma-ema-decay", type=float, default=None, help="Magma: EMA decay for damping factor (default: inherit or 0.9)")
...
while True:
    ...
    if last_step or (args.eval_every > 0 and step % args.eval_every == 0):
        ...
        with autocast_ctx:
            val_bpb, _ = evaluate_bpb(model, val_loader, eval_steps, token_bytes)
